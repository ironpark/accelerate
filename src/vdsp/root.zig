...
pub const SplitSlice = types.SplitSlice;
...
// -- zvecop --
const zvecop_mod = @import("zvecop.zig");
pub const zvadd = zvecop_mod.zvadd;
pub const zrvadd = zvecop_mod.zrvadd;
pub const zvsub = zvecop_mod.zvsub;
pub const zrvsub = zvecop_mod.zrvsub;
pub const zrvmul = zvecop_mod.zrvmul;
pub const zvdiv = zvecop_mod.zvdiv;
pub const zrvdiv = zvecop_mod.zrvdiv;
pub const zvabs = zvecop_mod.zvabs;
pub const zvfill = zvecop_mod.zvfill;
pub const zvmul = zvecop_mod.zvmul;
pub const zvcma = zvecop_mod.zvcma;
pub const zvma = zvecop_mod.zvma;
pub const zvcmul = zvecop_mod.zvcmul;
pub const zvconj = zvecop_mod.zvconj;
pub const zvzsml = zvecop_mod.zvzsml;
pub const zvmags = zvecop_mod.zvmags;
pub const zvmgsa = zvecop_mod.zvmgsa;
pub const zvmov = zvecop_mod.zvmov;
pub const zvneg = zvecop_mod.zvneg;
pub const zvphas = zvecop_mod.zvphas;
pub const zvsma = zvecop_mod.zvsma;
pub const zaspec = zvecop_mod.zaspec;
pub const zcoher = zvecop_mod.zcoher;
pub const ztrans = zvecop_mod.ztrans;
pub const zcspec = zvecop_mod.zcspec;
pub const desamp = zvecop_mod.desamp;
pub const zrdesamp = zvecop_mod.zrdesamp;
...
pub const inverseClip = clip_mod.inverseClip;
...
pub const maxMagnitude = clip_mod.maxMagnitude;
pub const vminmg = clip_mod.vminmg;
pub const minMagnitude = clip_mod.minMagnitude;
...
pub const vsortiAssumeSeeded = util_mod.vsortiAssumeSeeded;
